...
def get_args_parser():
    ...
    parser.add_argument("--model_type", default='ASTR', type=str,
                        help="which types of model you would use. model with multi-prompt(ASTR) or single-prompt(base)")
    ...
    parser.add_argument("--ontology_path", default='./data/templates/ontology_wikievent_full.csv', type=str,
                        help="a file containing all ontology we use for this dataset")
    ...
    parser.add_argument("--template_path3", default='./data/templates/templates_wikievent_full_t3.csv', type=str,
                        help="a file containing alltemplates we use for this dataset")
    ...
    parser.add_argument('--inference_model_path', default="/home/nlp/lwl/project/NLP/IJCAI2024/new/ASTR_v2.2_opt/exps/wikievent/test/checkpoint_ours_single", type=str,
    ...
    parser.add_argument('--moe_top_k', default=2, type=int,
                        help="MoE top-k expert selection")
